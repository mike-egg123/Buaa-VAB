    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          inputType !== 'textarea' ? React.createElement('input', { type: inputType, onChange: this.handleType, value: inputValue, placeholder: 'write some thing here..',className:'intro' }) : React.createElement('textarea', { type: inputType, onChange: this.handleType, value: inputValue, placeholder: 'write some thing here..', className:'intro' }),
...
React.createElement(TextLoader, {
  loaderColor: 'tomato',
  limit: '500',
  inputType: 'textarea' }), document.querySelector('#root'));